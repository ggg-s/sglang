...
class TestDSV4EmptyBatchMetadata(unittest.TestCase):
    ...
    def test_split_runner_still_executes_idle_model_layers(self):
        ...
        cp_utils = SimpleNamespace(
            is_cp_active=Mock(return_value=False),
            prepare_cp_forward=Mock(),
        )
        ...
        self.assertEqual(cp_utils.is_cp_active.call_count, 2)
        cp_utils.prepare_cp_forward.assert_not_called()
