...
class EagleDraftWorker(EagleDraftWorkerBase):
    ...
    def prefill_lane_draft_extend_backend(self):
        """Bind the prefill lane's own draft-extend backend for this call.

        A no-op unless PDMux standard built the second instance. Submission is
        synchronous host code, so the swap never spans two lanes' host work.
        """
